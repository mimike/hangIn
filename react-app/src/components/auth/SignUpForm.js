        ...
        <div className="sign-up-form">
          {pageNumber === 0 && (
            <form className="first-form-container">
              ...
              <div>
                <label>6 or more characters)</label>
                <input
                  required
                  type="password"
                  name="password"
            ...
            <form className="second-form-container">
              ...
              <div>
                ...
                >
                  ...
                  {skillz.map((skill) => (
                    <option type="text" value={skill} key={skill}>
                      {skill}
                    </option>
                  ))}
                </select>
          ...
          {pageNumber === 3 && (
            <form className="fourth-form-container">
              ...
              <div className="upload-avatar-box">
                <label className="upload-profile-label" htmlFor="file">
                  Upload Profile Photo<i class="fas fa-upload"></i>
                </label>
                <input
                  id="file"
              ...
              <div className="upload-avatar-box">
                <label className="upload-cover-label" htmlFor="file1">
                  Upload Cover Photo <i class="fas fa-upload"></i>
                </label>
                <input
                  id="file1"
                  className="input-file"
          ...
          {pageNumber === 4 && (
            <div className="validate_form">
              <h3>Account Info</h3>
              <h5 className="check">First name: {firstName}</h5>
              <h5 className="check">Last name: {lastName}</h5>
              <h5 className="check">City: {city}</h5>
              <h5 className="check">State: {state}</h5>

              <h5 className="check">Headline: {headline}</h5>

              <h5 className="check">Email: {email}</h5>

              <h5 className="check">About: {about}</h5>

              <h5 className="check">Experience: {experience}</h5>
              <h5 className="check">Main Discipline: {skills}</h5>
              ...
              <h4>
                By clicking Agree & Join, you agree to the HangIn User
                Agreement, Privacy Policy, and Cookie Policy.
              </h4>

              <button className="back-it-up" onClick={() => setPageNumber(0)}>
                Start Over Update
              </button>
            </div>
          )}
